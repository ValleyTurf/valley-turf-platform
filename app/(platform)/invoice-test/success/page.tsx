...
export default function InvoiceTestSuccessPage() {
  return (
    <main className="min-h-screen bg-[#f5f4ef] px-4 py-6 text-[#174734] sm:px-6 sm:py-8">
      <div className="mx-auto max-w-xl rounded-2xl bg-white p-6 text-center shadow">
        ...
        <p className="mt-2 text-sm text-[#6b705c]">
          Stripe redirected back here after a successful test charge.
          Check the Stripe Dashboard (Test mode) for the payment, and the
